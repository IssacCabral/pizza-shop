...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 1231asuidhu7</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Issac Cabral</TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-right">R$ 125,00</TableCell>
